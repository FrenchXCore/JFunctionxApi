...
public interface RestService {
    ...
    Call<eu.frenchxcore.cosmossdk.query.authz.QueryGrantsResponse> authzGrants(
            ...
            @Query(value = "pagination.offset", encoded = false) BigInteger paginationOffset,
            @Query(value = "pagination.limit", encoded = false) BigInteger paginationLimit,
            @Query(value = "pagination.count_total", encoded = false) Boolean paginationCountTotal,
            @Query(value = "pagination.reverse", encoded = false) Boolean paginationReversed
    );
     ...
     *
     * @param granter is the address of the user granting an allowance of their
     * funds.
     * @param grantee is the address of the user being granted an allowance of
    ...
    Call<eu.frenchxcore.cosmossdk.query.tx.GetTxResponse> txGetTx(
            @Path(value = "hash", encoded = false) String hash
    );
