 ...
 *
 */
@JsonTypeName("/fx.gravity.crosschain.v1.MsgSendToExternalClaim")
public class MsgSendToExternalClaim extends BaseMessage {
    ...
    @JsonProperty("batch_nonce")
    public BigInteger batchNonce;
