...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgConfirmBatch.class, name = "/fx.gravity.crosschain.v1.MsgConfirmBatch"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgOracleSetConfirm.class, name = "/fx.gravity.crosschain.v1.MsgOracleSetConfirm"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgOracleSetUpdatedClaim.class, name = "/fx.gravity.crosschain.v1.MsgOracleSetUpdatedClaim"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgRequestBatch.class, name = "/fx.gravity.crosschain.v1.MsgRequestBatch"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgSendToExternal.class, name = "/fx.gravity.crosschain.v1.MsgSendToExternal"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgSendToExternalClaim.class, name = "/fx.gravity.crosschain.v1.MsgSendToExternalClaim"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgSendToFxClaim.class, name = "/fx.gravity.crosschain.v1.MsgSendToFxClaim"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.crosschain.v1.MsgSetOrchestratorAddress.class, name = "/fx.gravity.crosschain.v1.MsgSetOrchestratorAddress"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgCancelSendToEth.class, name = "/fx.gravity.v1.MsgCancelSendToEth"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgConfirmBatch.class, name = "/fx.gravity.v1.MsgConfirmBatch"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgDepositClaim.class, name = "/fx.gravity.v1.MsgDepositClaim"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgFxOriginatedTokenClaim.class, name = "/fx.gravity.v1.MsgFxOriginatedTokenClaim"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgRequestBatch.class, name = "/fx.gravity.v1.MsgRequestBatch"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgSendToEth.class, name = "/fx.gravity.v1.MsgSendToEth"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgSetOrchestratorAddress.class, name = "/fx.gravity.v1.MsgSetOrchestratorAddress"),
    @JsonSubTypes.Type(value = eu.frenchxcore.fxcore.messages.gravity.v1.MsgValsetConfim.class, name = "/fx.gravity.v1.MsgValsetConfirm"),
