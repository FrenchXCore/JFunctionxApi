...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = eu.frenchxcore.model.fxcore.messages.gravity.v1.MsgSendToEth.class, name = "/fx.gravity.v1.MsgSendToEth"),
    @JsonSubTypes.Type(value = eu.frenchxcore.model.fxcore.messages.gravity.v1.MsgSetOrchestratorAddress.class, name = "/fx.gravity.v1.MsgSetOrchestratorAddress"),
