 ...
 * under the License.
 */
package eu.frenchxcore.model.fxcore.messages.gravity.v1;
 ...
 *
 */
@JsonTypeName("/fx.gravity.v1.MsgDepositClaim")
public class MsgDepositClaim extends BaseMessage {
    ...
    @JsonProperty("eth_sender")
    public String ethSender;
    
    @JsonProperty("fx_receiver")
    public String fxReceiver;
