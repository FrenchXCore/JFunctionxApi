...
public class ConsensusParamsValidator {
  ...
  private List<String> pubKeyTypes = new ArrayList<String>();


  public ConsensusParamsValidator pubKeyTypes(List<String> pubKeyTypes) {
    
    this.pubKeyTypes = pubKeyTypes;
    return this;
  }

  public ConsensusParamsValidator addPubKeyTypesItem(String pubKeyTypesItem) {
    this.pubKeyTypes.add(pubKeyTypesItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ConsensusParamsValidator consensusParamsValidator = (ConsensusParamsValidator) o;
    return Objects.equals(this.pubKeyTypes, consensusParamsValidator.pubKeyTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pubKeyTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsensusParamsValidator {\n");
    sb.append("    pubKeyTypes: ").append(toIndentedString(pubKeyTypes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
