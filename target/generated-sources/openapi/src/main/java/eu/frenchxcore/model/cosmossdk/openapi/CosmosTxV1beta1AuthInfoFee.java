 ...
 */
@ApiModel(description = "Fee is the fee and gas limit for the transaction. The first signer is the primary signer and the one which pays the fee. The fee can be calculated based on the cost of evaluating the body and doing signature verification of the signers. This can be estimated via simulation.")
...
public class CosmosTxV1beta1AuthInfoFee {
  ...
  public CosmosTxV1beta1AuthInfoFee amount(List<InlineResponse2003Balances> amount) {
    
    this.amount = amount;
    return this;
  }

  public CosmosTxV1beta1AuthInfoFee addAmountItem(InlineResponse2003Balances amountItem) {
    if (this.amount == null) {
  ...
  **/
  ...
  public CosmosTxV1beta1AuthInfoFee gasLimit(String gasLimit) {
  ...
  **/
  ...
  public CosmosTxV1beta1AuthInfoFee payer(String payer) {
  ...
  **/
  ...
  public CosmosTxV1beta1AuthInfoFee granter(String granter) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CosmosTxV1beta1AuthInfoFee cosmosTxV1beta1AuthInfoFee = (CosmosTxV1beta1AuthInfoFee) o;
    return Objects.equals(this.amount, cosmosTxV1beta1AuthInfoFee.amount) &&
        Objects.equals(this.gasLimit, cosmosTxV1beta1AuthInfoFee.gasLimit) &&
        Objects.equals(this.payer, cosmosTxV1beta1AuthInfoFee.payer) &&
        Objects.equals(this.granter, cosmosTxV1beta1AuthInfoFee.granter);
  }
  ...
  public String toString() {
    ...
    sb.append("class CosmosTxV1beta1AuthInfoFee {\n");
